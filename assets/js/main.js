...
const listItemNavBarSubmenuLink = SS(
  ".navbar__sub-menu-mobile-list-item.have-sub-menu"
);
...
for (let i = 0; i < listItemNavbarMobile.length; i++) {
  ...
  listItemNavbarMobile[i].addEventListener("click", (e) => {
    const listItemNavbarMobileIcon = listItemNavbarMobile[i].querySelector(
      ".header__mobile-navbar-list-item-link-icon"
    );
    listItemNavbarMobileIcon.classList.toggle("active");
  });
  listItemNavbarMobile[i].addEventListener("click", (e) => {
    const subMenuOne = listItemNavbarMobile[i].querySelector(
      ".navbar__sub-menu-mobile"
    );
  ...
  listItemNavbarMobile[i].addEventListener("click", (e) => {
    for (let j = 0; j < listItemNavbarMobile.length; j++) {
      if (j !== i) {
        ...
        const listItemNavbarMobileIcon = listItemNavbarMobile[j].querySelector(
          ".header__mobile-navbar-list-item-link-icon"
        );
        const subMenuOne = listItemNavbarMobile[j].querySelector(
          ".navbar__sub-menu-mobile"
        );
...
for (let i = 0; i < listItemNavBarSubmenuLink.length; i++) {
  const aTag = listItemNavBarSubmenuLink[i].querySelector(
    ".navbar__sub-menu-mobile-list-item-link.have-sub-menu"
  );
  ...
  aTag.addEventListener("click", (e) => {
    listItemNavBarSubmenuLink[i]
      .querySelector(".navbar__sub-menu-mobile.have-one-sub-menu")
      .classList.toggle("active");
  });
  aTag.addEventListener("click", (e) => {
    listItemNavBarSubmenuLink[i]
      .querySelector(".header__mobile-navbar-list-item-link-icon")
      .classList.toggle("active");
